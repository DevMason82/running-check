//
//  MonthlyInfoViewSaveImage.swift
//  running-check
//
...
struct MonthlyInfoViewSaveImage: View {
    let month: String
    ...
    var body: some View {
        VStack() {
            ...
            KMTotalView2(totalDistance: totalDistance, prevTotalDistance: prevTotalDistance)
            VStack() {
                Text("*비교값: 지난달")
                    .font(.caption)
